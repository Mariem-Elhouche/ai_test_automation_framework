...
Feature: Edit company category
  ...
  @TC_EDIT_001
  Scenario: Edit category name and code successfully
    When the user edits the category "Cas-Test4-Maryem" and changes its name to "Cas-Test4-Maryem-edited" and its code to "9999"
    Then a category edit confirmation message is displayed
    And the category "Cas-Test4-Maryem-edited" appears in the list with the new code "9999"

  @TC_EDIT_002
  Scenario: Edit category code successfully
    When the user edits the category "Cas-Test4-Maryem" and changes its code to "1345"
    Then a category edit confirmation message is displayed
    And the category "Cas-Test4-Maryem" appears in the list with the new code "1345"
